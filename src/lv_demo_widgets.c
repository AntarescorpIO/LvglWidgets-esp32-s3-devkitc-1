...
void lv_demo_widgets(void)
{
    ...
    if(disp_size == DISP_LARGE) {
        ...
        lv_label_set_text(label, "Libreria virtual grafica ");
        lv_obj_align_to(label, logo, LV_ALIGN_OUT_RIGHT_TOP, 10, 0);

        label = lv_label_create(tab_btns);
        lv_label_set_text(label, "Accesorios de demostracion");
        lv_obj_add_style(label, &style_text_muted, 0);
        lv_obj_align_to(label, logo, LV_ALIGN_OUT_RIGHT_BOTTOM, 10, 0);
    }

    lv_obj_t * t1 = lv_tabview_add_tab(tv, "Marca");
    lv_obj_t * t2 = lv_tabview_add_tab(tv, "Las ventas");
    lv_obj_t * t3 = lv_tabview_add_tab(tv, "La tiendita");
    profile_create(t1);
    analytics_create(t2);
    shop_create(t3);
...
static void profile_create(lv_obj_t * parent)
{
    ...
    lv_label_set_text(name, "Doña Malinche");
    lv_obj_add_style(name, &style_title, 0);

    lv_obj_t * dsc = lv_label_create(panel1);
    lv_obj_add_style(dsc, &style_text_muted, 1);
    lv_label_set_text(dsc, "Las distintas lenguas y lenguajes son mi especialidad");
    ...
    lv_label_set_text(email_label, "DonaMalinche@tenchtitlan.com");
    ...
    lv_label_set_text(call_label, "+5546992275");
    ...
    lv_label_set_text(label, "Invitacion");
    lv_obj_center(label);
    ...
    lv_label_set_text(gender_label, "Que prefieres");
    lv_obj_add_style(gender_label, &style_text_muted, 0);

    lv_obj_t * gender = lv_dropdown_create(panel2);
    lv_dropdown_set_options_static(gender, "Morder almoada\nSoplar Nuca \nde los 2");

    lv_obj_t * birthday_label = lv_label_create(panel2);
    lv_label_set_text(birthday_label, "Cumple Años");
    ...
    lv_label_set_text(panel3_title, "Buena pal metatate");
    lv_obj_add_style(panel3_title, &style_title, 0);

    lv_obj_t * experience_label = lv_label_create(panel3);
    lv_label_set_text(experience_label, "Malos pal petate");
    lv_obj_add_style(experience_label, &style_text_muted, 1);
    ...
    lv_label_set_text(team_player_label, "Team Sophs");
    ...
    lv_label_set_text(hard_working_label, "Tabajo duro");
...
static void analytics_create(lv_obj_t * parent)
{
    ...
    lv_label_set_text(title, "Visitantes fans");
    ...
    lv_label_set_text(title, "Renuevan Mensualmente");
    lv_obj_add_style(title, &style_title, 0);
    lv_obj_set_grid_cell(title, LV_GRID_ALIGN_START, 0, 2, LV_GRID_ALIGN_START, 0, 1);
    ...
    meter1 = create_meter_box(parent, "Desempeño Mensual", "Renovaciones: 63%", "Ventas: 44%", "Costos: 58%");
    ...
    meter2 = create_meter_box(parent, "Seciones", "Escritorio: ", "Tabletas: ", "Celulares: ");
    ...
    meter3 = create_meter_box(parent, "Velocidad de Red", "Baja Velocidad", "Velocidad Normal", "Velocidad Alta");
...
void shop_create(lv_obj_t * parent)
{
    ...
    create_shop_item(list, &img_clothes, "Tanga de las CAmerica", "p/Caballero", "$1522");
    create_shop_item(list, &img_clothes, "Cola de aguila", "Jugete Sexual", "$911");
    create_shop_item(list, &img_clothes, "Foto del Cuahu", "poster deportivo", "$917");
    create_shop_item(list, &img_clothes, "Condones sabor nido de aguila", "preservativo", "$284");
    create_shop_item(list, &img_clothes, "Pantalone de Caballero", "Ropa de vestir", "$105");
    ...
    lv_label_set_text(title, "Avisos importantes");
    lv_obj_add_style(title, &style_title, 0);

    lv_obj_t * cb;
    cb = lv_checkbox_create(notifications);
    lv_checkbox_set_text(cb, "Dale like si te gusto");

    cb = lv_checkbox_create(notifications);
    lv_checkbox_set_text(cb, "Comparte y sigueme");

    cb = lv_checkbox_create(notifications);
    lv_checkbox_set_text(cb, "Desarrollador Mexicano");
    lv_obj_add_state(cb, LV_STATE_CHECKED);

    cb = lv_checkbox_create(notifications);
    lv_checkbox_set_text(cb, "La tecnica al servicio de la Patria --IPN--");
    lv_obj_add_state(cb, LV_STATE_DISABLED);

    cb = lv_checkbox_create(notifications);
    lv_checkbox_set_text(cb, "de Iztapalapa para el Mundo");
    lv_obj_add_state(cb, LV_STATE_CHECKED | LV_STATE_DISABLED);

    cb = lv_checkbox_create(notifications);
    lv_checkbox_set_text(cb, "¡¡¡Calderon es inocente!!! liberen a Garcia luna!!!! jajaja");
